...
import com.android.view.animation.textsurface.common.Position;
import com.android.view.animation.textsurface.common.ScaleValue;
...
public class Text implements Comparable<Text> {
	...
	private ArrayList<ITextEffect> effects = new ArrayList<ITextEffect>();
	private float dx;
