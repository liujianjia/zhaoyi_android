...
public class RecoverPasswordActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = RecoverPasswordActivity.this;
        ...
        name = ZyApplication.getInstance()
                .getUserJson()
    ...
    private void verifyAndUpdateOnSever(String oldPassword, String newPassword) {
        if (TextUtils.isEmpty(name)) {
            Log.e("Error: ", "user name can't be empty.");
            return;
        }
        ...
        OkHttpManager.getInstance().post(params, MyContants.BASE_URL + MyContants.CHANGEPASSWORD,
