 ...
 * 同时展示如何进行节点浏览并弹出泡泡
 */
public class MultiRoutePlan extends Activity implements BaiduMap.OnMapClickListener,
    ...
    private Button btnQuitGuide;
    boolean isFirstLoc = true; // 是否首次定位
    boolean isGuideMode = false; // 是否为导航模式
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dest = bundle.getParcelable("destLoc");
        src = dest;
        mBaidumap.clear();
        ...
        if(!TextUtils.isEmpty(CurrentHosInfo.getCurHosAddress())) {
            ...
            ((TextView)view.findViewById(R.id.tv_dest)).setTextColor(getResources().getColor(R.color.black2));
            LinearLayout layout = (LinearLayout) view.findViewById(R.id.ll_dest);

            layout.setOrientation(LinearLayout.HORIZONTAL);

            mInfoWindow = new InfoWindow(BitmapDescriptorFactory.fromView(view), dest, -47, null);
    ...
    BaiduMap.OnMarkerClickListener listener = new BaiduMap.OnMarkerClickListener() {
        ...
        public boolean onMarkerClick(final Marker marker) {
            if (!TextUtils.isEmpty(CurrentHosInfo.getCurHosAddress())) {
                ...
                ((TextView) view.findViewById(R.id.tv_dest)).setText(
                        CurrentHosInfo.getCurHosAddress());
                ((TextView) view.findViewById(R.id.tv_dest)).setTextColor(
                        getResources().getColor(R.color.black2));
    ...
    public void searchButtonProcess(View v) {
        ...
        //String[] addr = splitStr(CurrentHosInfo.getCurHosAddress());
        //PlanNode stNode = PlanNode.withCityNameAndPlaceName(endNodeStr, startNodeStr);
        PlanNode stNode = PlanNode.withLocation(src);
        //PlanNode enNode = PlanNode.withCityNameAndPlaceName(addr[1], addr[2]);
        ...
        if (v.getId() == R.id.mass) {
            ...
            PlanNode stMassNode = PlanNode.withLocation(src);
            //PlanNode enMassNode = PlanNode.withCityNameAndPlaceName(addr[1], addr[2]);
            PlanNode enMassNode = PlanNode.withLocation(dest);
    ...
    private void setUpGuide() {
        requestLocButton = (Button) findViewById(R.id.btn_map_guide);
        btnQuitGuide = (Button) findViewById(R.id.btn_map_quit_guide);
        mCurrentMode = MyLocationConfiguration.LocationMode.NORMAL;
        requestLocButton.setText("普通");
        /*btnQuitGuide.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        View.OnClickListener btnClickListener = new View.OnClickListener() {
            public void onClick(View v) {
                //btnQuitGuide.setCursorVisible(true);
                switch (mCurrentMode) {
                    case NORMAL:
    ...
    public void nodeClick(View v) {
        ...
        // show popup
        popupText = new TextView(MultiRoutePlan.this);
    ...
    public void changeRouteIcon(View v) {
        ...
        if(isGuideMode) {
            mBaidumap.setMyLocationEnabled(true);
            //btnQuitGuide.setCursorVisible(false);
            btnQuitGuide.setText("关闭导航");
            mLocClient.start();
    ...
    public void onGetWalkingRouteResult(WalkingRouteResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(MultiRoutePlan.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
        }
        ...
        if (result.error == SearchResult.ERRORNO.NO_ERROR) {
            ...
            if (result.getRouteLines().size() > 1 ) {
                ...
                MyTransitDlg myTransitDlg = new MyTransitDlg(MultiRoutePlan.this,
