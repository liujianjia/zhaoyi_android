 ...
 * implements
 * {@link android.support.percent.expand.PercentLayoutHelper.PercentLayoutParams}.
...
public class PercentLayoutHelper {
				...
				if (info != null) {
					...
					if (view instanceof TextView) {
						...
						if (textSizePercent != null) {
							int base = textSizePercent.isBaseWidth ? widthHint
									: heightHint;
	...
	public static PercentLayoutInfo getPercentLayoutInfo(Context context,
		...
		// 1, 1,
		// -1f);
		String sizeStr = array
				.getString(R.styleable.PercentLayout_Layout_layout_widthPercent);
